  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="<?php echo e(route('popular_places.update',0)); ?>" id="updateForm">
        <?php echo method_field('PUT'); ?>
        <?php echo csrf_field(); ?>
        <input type="hidden" name="id" id="update_form_id">
        <div class="form-group">
          <label for="exampleInputEmail1"><?php echo e(__('Place Name')); ?></label>
        ...
        <div class="form-group">
              ...
              <input type="file" name="image_path" class="upload_image">
              <div class="attached_files_div"></div>
        </div>
        <div class="form-group oldThumb" style="display: none;">
            <label for=""><strong><?php echo e(__('Old Place Image')); ?></strong></label>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="<?php echo e(route('popular_places.store')); ?>" id="">
        <?php echo csrf_field(); ?>
        <div class="form-group">
          <label for="exampleInputEmail1"><?php echo e(__('Place Name')); ?></label>
        ...
        <div class="form-group">
                <label for=""><?php echo e(__('Place Image')); ?></label>
                <input type="file" name="image_path" class="upload_image">
                <div class="attached_files_div"></div>
        </div>
      </div>
...
<!---------AddModal End Here---------><?php /**PATH D:\2-Projects Data\Laravel + React Assignment\resources\views/back/property/places/modal.blade.php ENDPATH**/ ?>